...
public class DesignBrowserHistoryTest {
    ...
    public void defaultTest() {
        ...
        assertEquals(
                "facebook.com",
                designBrowserHistory.forward(1)
        );
        designBrowserHistory.visit("linkedin.com");     // You are in "facebook.com". Visit "linkedin.com"
        assertEquals(
                "linkedin.com",
                designBrowserHistory.forward(2)
        );
        assertEquals(
                "google.com",
                designBrowserHistory.back(2)
        );
        assertEquals(
                "leetcode.com",
                designBrowserHistory.back(7)
        );
    }
