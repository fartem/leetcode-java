...
public class DesignFrontMiddleBackQueueTest {
    ...
    public void defaultTest() {
        ...
        assertEquals(1, designFrontMiddleBackQueue.popFront());
        assertEquals(3, designFrontMiddleBackQueue.popMiddle());
        assertEquals(4, designFrontMiddleBackQueue.popMiddle());
        assertEquals(2, designFrontMiddleBackQueue.popBack());
        assertEquals(-1, designFrontMiddleBackQueue.popFront());
    }
